...
INSERT INTO parks (park_name, latitutde, longitude, state_abbr, image)
...
INSERT INTO parks_in_states (parks_id)
SELECT id FROM parks;

SELECT * FROM parks WHERE state_abbr='CA'

SELECT *
FROM parks
INNER JOIN parks_in_states ON parks.id = parks_in_states.parks_id
INNER JOIN states ON parks_in_states.state_id = states.state_id
